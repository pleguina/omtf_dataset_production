"""
C13_prompt_pt2to5_overlap_PU200 — Single Prompt Muon, OMTF overlap region, PU200.
...
generator = cms.EDProducer("FlatRandomPtGunProducer2",
    ...
    psethack        = cms.string('single prompt muon flatOneOverPt 2-5 GeV d0<0.05cm OMTF overlap PU200'),
