"""
C14_prompt_pt5to10_overlap_PU200 — Single Prompt Muon, OMTF overlap region, PU200.
...
Purpose:
  PU200 prompt control for displaced discriminant validation at realistic occupancy.
  Part of WP4/WP5 (new_datset_reqs.md).
"""
...
generator = cms.EDProducer("FlatRandomPtGunProducer2",
    ...
    psethack        = cms.string('single prompt muon flatOneOverPt 5-10 GeV d0<0.05cm OMTF overlap PU200'),
