"""
C15_disp_pt2to5_overlap_PU200 — Single Displaced Muon, OMTF overlap region, PU200.
...
generator = cms.EDProducer("FlatRandomPtGunProducer2",
    ...
    psethack        = cms.string('single displaced muon flatOneOverPt 2-5 GeV d0 0.2-50cm OMTF overlap PU200'),
