"""
G10_pos - Hard negative: single high-eta muon, PU200, positive eta.
...
generator = cms.EDProducer("FlatRandomPtGunProducer2",
    ...
    psethack        = cms.string('single high-eta muon flatOneOverPt 2-200 GeV 1.30<eta<1.80 hard-negative PU200'),
