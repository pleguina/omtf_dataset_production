"""
C23_disp_pt50to100_overlap_PU200 — Single Displaced Muon, OMTF overlap region, PU200.
pT-binned controlled sample for displaced recovery validation at realistic occupancy.

Key properties:
  n muons/event: 1  (charge randomised)
  pT: flat in 1/pT over [50, 100] GeV  (controlled pT bin)
...
generator = cms.EDProducer("FlatRandomPtGunProducer2",
    ...
    psethack        = cms.string('single displaced muon flatOneOverPt 50-100 GeV d0 0.2-50cm OMTF overlap PU200'),
