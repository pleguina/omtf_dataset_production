"""
G4 — Single Displaced Muon, OMTF overlap region, PU200.

GMT-visible-stub campaign: clean 1-candidate displaced overlap under PU200.
Clean replacement for the ambiguous B2 role in the GMT-overlap branch.
...
generator = cms.EDProducer("FlatRandomPtGunProducer2",
    ...
    psethack        = cms.string('single displaced muon flatOneOverPt flatD0 d0 0-50cm OMTF overlap PU200'),
