"""
G16_neg_promptEndcap_PU200 — Single Prompt Muon, deep endcap region (|eta| > 1.8), PU200.
...
generator = cms.EDProducer("FlatRandomPtGunProducer2",
    ...
    psethack        = cms.string('single prompt muon flatOneOverPt 2-200 GeV -3.0<eta<-1.8 deep endcap PU200'),
