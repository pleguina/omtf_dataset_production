"""
G14_pos_promptTransition_PU200 — Single Prompt Muon, transition/guard-band region, PU200.
...
Key properties:
  ...
  eta: 1.2 < eta < 1.6  (transition/guard band)
  phi: full 2pi
...
generator = cms.EDProducer("FlatRandomPtGunProducer2",
    ...
    psethack        = cms.string('single prompt muon flatOneOverPt 2-200 GeV 1.2<eta<1.6 transition guard PU200'),
