"""
C19_prompt_pt50to100_overlap_PU200 — Single Prompt Muon, OMTF overlap region, PU200.
...
generator = cms.EDProducer("FlatRandomPtGunProducer2",
    ...
    psethack        = cms.string('single prompt muon flatOneOverPt 50-100 GeV d0<0.05cm OMTF overlap PU200'),
