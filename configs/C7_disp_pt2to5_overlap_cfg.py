...
# with command line options: Configuration/GenProduction/python/OMTF_HECIN/C7_disp_pt2to5_overlap.py --python_filename /afs/cern.ch/user/p/pleguina/omtf_dataset_production/configs/C7_disp_pt2to5_overlap_cfg.py --fileout file:C7_disp_pt2to5_overlap.root --eventcontent FEVTSIM --datatier GEN-SIM-DIGI-RAW --conditions 140X_mcRun4_realistic_v4 --geometry Extended2026D110 --era Phase2C17I13M9 --beamspot HLLHC14TeV --step GEN,SIM,DIGI:pdigi_valid,L1 --nThreads 4 --customise_commands "process.trackerGeometry.applyAlignment=cms.bool(False)" --no_exec -n 100
