...
# with command line options: Configuration/GenProduction/python/OMTF_HECIN/C8_disp_pt5to10_overlap.py --python_filename /afs/cern.ch/user/p/pleguina/omtf_hecin_dataset_production/configs/C8_disp_pt5to10_overlap_cfg.py --fileout file:C8_disp_pt5to10_overlap.root --eventcontent FEVTSIM --datatier GEN-SIM-DIGI-RAW --conditions 140X_mcRun4_realistic_v4 --geometry Extended2026D110 --era Phase2C17I13M9 --beamspot HLLHC14TeV --step GEN,SIM,DIGI:pdigi_valid,L1 --nThreads 4 --customise_commands "process.trackerGeometry.applyAlignment=cms.bool(False)" --no_exec -n 100
...
process.configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('Configuration/GenProduction/python/OMTF_HECIN/C8_disp_pt5to10_overlap.py nevts:100'),
...
process.FEVTSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:C8_disp_pt5to10_overlap.root'),
...
process.generator = cms.EDProducer("FlatRandomPtGunProducer2",
    ...
    psethack = cms.string('single displaced muon flatOneOverPt 5-10 GeV d0 0.2-50cm OMTF overlap')
)
