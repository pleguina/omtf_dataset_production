...
# with command line options: Configuration/GenProduction/python/OMTF_HECIN/S1_singleMuon_1overPt.py --python_filename S1_cfg.py --eventcontent FEVTSIM --datatier GEN-SIM-DIGI-RAW --conditions 140X_mcRun4_realistic_v4 --geometry Extended2026D110 --era Phase2C17I13M9 --beamspot HLLHC14TeV --step GEN,SIM,DIGI:pdigi_valid,L1 --nThreads 4 --fileout file:S1.root --no_exec -n 100
...
process.configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('Configuration/GenProduction/python/OMTF_HECIN/S1_singleMuon_1overPt.py nevts:100'),
...
process.FEVTSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:S1.root'),
...
process.etaFilter = cms.EDFilter("MCParticleModuloFilter",
