...
# with command line options: Configuration/GenProduction/python/OMTF_HECIN/G13_neg_promptTransition.py --python_filename /afs/cern.ch/user/p/pleguina/omtf_hecin_dataset_production/configs/G13_neg_promptTransition_cfg.py --fileout file:G13_neg_promptTransition.root --eventcontent FEVTSIM --datatier GEN-SIM-DIGI-RAW --conditions 140X_mcRun4_realistic_v4 --geometry Extended2026D110 --era Phase2C17I13M9 --beamspot HLLHC14TeV --step GEN,SIM,DIGI:pdigi_valid,L1 --nThreads 4 --no_exec -n 100
...
process.configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('Configuration/GenProduction/python/OMTF_HECIN/G13_neg_promptTransition.py nevts:100'),
...
process.FEVTSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:G13_neg_promptTransition.root'),
