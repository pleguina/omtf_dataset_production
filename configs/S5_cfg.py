...
# with command line options: Configuration/GenProduction/python/OMTF_HECIN/S5_diMuon_displaced.py --python_filename S5_cfg.py --eventcontent FEVTSIM --datatier GEN-SIM-DIGI-RAW --conditions 140X_mcRun4_realistic_v4 --beamspot HLLHC14TeV --step GEN,SIM,DIGI:pdigi_valid,L1 --geometry Extended2026D110 --era Phase2C17I13M9 --nThreads 4 --fileout file:S5.root --no_exec -n 100
...
process.configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('Configuration/GenProduction/python/OMTF_HECIN/S5_diMuon_displaced.py nevts:100'),
...
process.FEVTSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:S5.root'),
