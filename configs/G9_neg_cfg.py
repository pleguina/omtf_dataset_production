...
# with command line options: Configuration/GenProduction/python/OMTF_HECIN/G9_neg_hardNegHighEtaMuon.py --python_filename /afs/cern.ch/user/p/pleguina/omtf_dataset_production/configs/G9_neg_cfg.py --eventcontent FEVTSIM --datatier GEN-SIM-DIGI-RAW --conditions 140X_mcRun4_realistic_v4 --geometry Extended2026D110 --era Phase2C17I13M9 --beamspot HLLHC14TeV --step GEN,SIM,DIGI:pdigi_valid,L1 --nThreads 4 --fileout file:G9_neg.root --no_exec -n 100
