...
# with command line options: Configuration/GenProduction/python/OMTF_HECIN/G9_neg_hardNegHighEtaMuon.py --python_filename /afs/cern.ch/user/p/pleguina/omtf_hecin_dataset_production/configs/G9_neg_cfg.py --eventcontent FEVTSIM --datatier GEN-SIM-DIGI-RAW --conditions 140X_mcRun4_realistic_v4 --geometry Extended2026D110 --era Phase2C17I13M9 --beamspot HLLHC14TeV --step GEN,SIM,DIGI:pdigi_valid,L1 --nThreads 4 --fileout file:G9_neg.root --no_exec -n 100
...
process.configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('Configuration/GenProduction/python/OMTF_HECIN/G9_neg_hardNegHighEtaMuon.py nevts:100'),
...
process.FEVTSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:G9_neg.root'),
...
process.generator = cms.EDProducer("FlatRandomPtGunProducer2",
    ...
    PGunParameters = cms.PSet(
        ...
        MaxEta = cms.double(-1.30),
        MaxPhi = cms.double(3.14159265359),
        MaxPt = cms.double(200.0),
        MinDxy = cms.double(0.0),
        MinEta = cms.double(-1.80),
    ...
    psethack = cms.string('single high-eta muon flatOneOverPt 2-200 GeV -1.80<eta<-1.30 hard-negative')
)
