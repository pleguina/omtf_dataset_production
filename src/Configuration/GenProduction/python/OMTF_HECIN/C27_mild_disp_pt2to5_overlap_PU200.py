"""
C27_mild_disp_pt2to5_overlap_PU200 — Single Mild-Displaced Muon, OMTF overlap region PU200.
...
generator = cms.EDProducer("FlatRandomPtGunProducer2",
    ...
    psethack        = cms.string('single mild-displaced muon flatOneOverPt 2-5 GeV d0 0.05-0.2cm OMTF overlap PU200'),
