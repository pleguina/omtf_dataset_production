"""
C17_prompt_pt10to20_overlap_PU200 — Single Prompt Muon, OMTF overlap region, PU200.
...
generator = cms.EDProducer("FlatRandomPtGunProducer2",
    ...
    psethack        = cms.string('single prompt muon flatOneOverPt 10-20 GeV d0<0.05cm OMTF overlap PU200'),
