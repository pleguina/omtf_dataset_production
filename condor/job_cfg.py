...
# with command line options: Configuration/GenProduction/python/OMTF_HECIN/S3_diMuon_sameSector.py --python_filename S3_cfg.py --eventcontent FEVTSIM --datatier GEN-SIM-DIGI-RAW --conditions 140X_mcRun4_realistic_v4 --beamspot HLLHC14TeV --step GEN,SIM,DIGI:pdigi_valid,L1 --geometry Extended2026D110 --era Phase2C17I13M9 --nThreads 4 --fileout file:S3_699.root --no_exec -n 100
...
process.configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('Configuration/GenProduction/python/OMTF_HECIN/S3_diMuon_sameSector.py nevts:100'),
...
process.FEVTSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:S3_699.root'),
...
process.generator = cms.EDProducer("FlatRandomPtGunProducer2",
    ...
    PGunParameters = cms.PSet(
        ...
        MaxPhi = cms.double(1.0471975511965976),
        MaxPt = cms.double(100.0),
        MinDxy = cms.double(0.0),
        MinEta = cms.double(0.82),
        MinPhi = cms.double(-1.0471975511965976),
...
process.RandomNumberGeneratorService.generator = cms.PSet(
    initialSeed = cms.untracked.uint32(5535394),
)
if hasattr(process.RandomNumberGeneratorService, 'VtxSmeared'):
    process.RandomNumberGeneratorService.VtxSmeared.initialSeed = cms.untracked.uint32(6535394)
if hasattr(process.RandomNumberGeneratorService, 'g4SimHits'):
    process.RandomNumberGeneratorService.g4SimHits.initialSeed = cms.untracked.uint32(7535394)
process.TFileService.fileName = cms.string('omtf_hits_S3_699.root')
if hasattr(process, 'NANOOMTFoutput'):
    process.NANOOMTFoutput.fileName = cms.untracked.string('omtf_nano_S3_699.root')
